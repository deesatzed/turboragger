...
- Candidate brief count: 10 active/recent.
...
- Stagnation check: same-source fusion, learned calibration, deeper same-source candidate pools, graded-regression deeper candidate pools, current-source token MaxSim late interaction, second-stage late-interaction calibration, and tiny SciFact-style domain fine-tuning have not closed the SOTA gap.
