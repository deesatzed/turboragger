...
- Candidate brief count: 7 active/recent.
...
- Stagnation check: same-source fusion, learned calibration, deeper same-source candidate pools, and current-source token MaxSim late interaction have not closed the SOTA gap.
