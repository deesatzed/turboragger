...
- Candidate brief count: 6 active/recent.
...
- Stagnation check: same-source fusion, learned calibration, and deeper same-source candidate pools are yielding sub-`0.002` primary-metric movements and have not closed the SOTA gap.
